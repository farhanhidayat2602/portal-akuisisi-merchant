...
const branches = [
  ...
  { code: 'KC_SUPRAPTO',           name: 'KCP Suprapto',             city: 'Balikpapan',      lat: -1.2683, lng: 116.8296 },
  { code: 'KC_AHMAD_YANI',         name: 'KCP Ahmad Yani',           city: 'Balikpapan',      lat: -1.2600, lng: 116.8411 },
  { code: 'KC_SUDIRMAN',           name: 'KCP Sudirman',             city: 'Balikpapan',      lat: -1.2640, lng: 116.8329 },
  { code: 'KC_BALIKPAPAN_BARU',    name: 'KCP Balikpapan Baru',      city: 'Balikpapan',      lat: -1.2408, lng: 116.8502 },
  { code: 'KC_KARANG_JATI',        name: 'KCP Karang Jati',          city: 'Balikpapan',      lat: -1.2511, lng: 116.8349 },
  { code: 'KC_BATAKAN',            name: 'KCP Batakan',              city: 'Balikpapan',      lat: -1.3117, lng: 116.8205 },
  { code: 'KC_TELKOM_DIVRE',       name: 'KCP Telkom Divre VI',      city: 'Balikpapan',      lat: -1.2634, lng: 116.8504 },
  { code: 'KC_MUARA_RAPAK',        name: 'KCP Muara Rapak',          city: 'Balikpapan',      lat: -1.2079, lng: 116.8384 },
  { code: 'KC_SUPERBLOCK',         name: 'KCP Superblock',           city: 'Balikpapan',      lat: -1.2554, lng: 116.8447 },
  { code: 'KC_SOEKARNO_HATTA',     name: 'KCP Soekarno Hatta',       city: 'Balikpapan',      lat: -1.2265, lng: 116.8615 },
  { code: 'KC_SEPAKU',             name: 'KCP Sepaku',               city: 'PPU (IKN)',       lat: -1.1847, lng: 116.9169 },
  { code: 'KC_PENAJEM_PASER',      name: 'KCP Penajem Paser Utara',  city: 'PPU',             lat: -1.3517, lng: 116.4167 },
  { code: 'KC_BABULU_DARAT',       name: 'KCP Babulu Darat',         city: 'PPU',             lat: -1.7500, lng: 116.2000 },
  { code: 'KC_TANAH_GROGOT',       name: 'KCP Tanah Grogot',         city: 'Paser',           lat: -1.9167, lng: 116.2167 },
  { code: 'KC_BATU_KAJANG',        name: 'KCP Batu Kajang',          city: 'Paser',           lat: -1.9547, lng: 115.9833 },
  { code: 'KC_SIMPANG_PAIT',       name: 'KCP Simpang Pait',         city: 'Paser',           lat: -1.8947, lng: 115.9833 },
  { code: 'KC_PASE_KUARO',         name: 'KCP Pase Kuaro',           city: 'Paser',           lat: -1.9700, lng: 116.2400 },
  { code: 'KC_MALINAU',            name: 'KCP Malinau',              city: 'Malinau',         lat: 3.5847,  lng: 116.6289 },
  { code: 'KC_NUNUKAN',            name: 'KCP Nunukan',              city: 'Nunukan',         lat: 4.1373,  lng: 117.6682 },
  { code: 'KC_PULAU_SEBATIK',      name: 'KCP Pulau Sebatik',        city: 'Nunukan',         lat: 4.2000,  lng: 117.7500 },
  { code: 'KC_PULAU_BUNYU',        name: 'KCP Pulau Bunyu',          city: 'Pulau Bunyu',     lat: 3.4667,  lng: 117.8667 },
  { code: 'KC_TANJUNG_SELOR',      name: 'KCP Tanjung Selor',        city: 'Tanjung Selor',   lat: 2.8291,  lng: 117.3733 },
  { code: 'KC_TANJSEL_SENKAWIT',   name: 'KCP Tanjung Selor Senkawit', city: 'Tanjung Selor', lat: 2.8400,  lng: 117.3900 },
  { code: 'KC_TANJUNG_REDEB',      name: 'KCP Tanjung Redeb',        city: 'Berau',           lat: 2.1333,  lng: 117.5000 },
  { code: 'KC_TARAKAN_SIMPANG',    name: 'KCP Tarakan Simpang Tiga', city: 'Tarakan',         lat: 3.3100,  lng: 117.5700 },
]
